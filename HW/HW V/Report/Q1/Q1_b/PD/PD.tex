...
\begin{itemize}
	...
	\begin{figure}[H]
		...
		\centering
		\includegraphics[width=12cm]{../Figure/Q1/Q1_b/PD/feedback_step.png}
	\end{figure}
	\item closeloop bode (magnitude) with PD controller
	\begin{figure}[H]
		\caption{closeloop bode (magnitude)}
		\centering
		\includegraphics[width=12cm]{../Figure/Q1/Q1_b/PD/feedback_bode.png}
	\end{figure}
	\item openloop bode (magnitude) with PD controller
	\begin{figure}[H]
		\caption{openloop bode (magnitude)}
		\centering
		\includegraphics[width=12cm]{../Figure/Q1/Q1_b/PD/openloop_bode.png}
	\end{figure}
	\item sensitivity function with PD controller
	\begin{figure}[H]
		\caption{sensitivity function}
		\centering
		\includegraphics[width=12cm]{../Figure/Q1/Q1_b/PD/s_bode.png}
	\end{figure}
	\item complementary sensitivity function with PD controller
	\begin{figure}[H]
		\caption{complementary sensitivity function}
		\centering
		\includegraphics[width=12cm]{../Figure/Q1/Q1_b/PD/t_bode.png}
	\end{figure}
\end{itemize}
